...
def create_sheet(wb, source, sheet_name):
...
def fill_sheet(code, browser, sheet):
...
for code in codes:
    ...
    sheet = create_sheet(wb, "Sheet1", name_code)
    fill_sheet(number_code, browser, sheet)
